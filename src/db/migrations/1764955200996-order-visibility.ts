...
export class OrderVisibility1764955200996 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "role_visibilities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role_id" uuid NOT NULL, "visible_role_id" uuid NOT NULL, "display_order" integer NOT NULL DEFAULT '0', "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fab4ac3b91a508719c906540a7f" UNIQUE ("role_id", "visible_role_id"), CONSTRAINT "PK_ca3af95dcbd54409a6552f9f80f" PRIMARY KEY ("id"))`);
